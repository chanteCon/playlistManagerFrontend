...
export default function VideoCard({ video, children }: VideoCardProps) {
    return (
        <div
            className="relative group h-[200px] w-[220px] overflow-hidden rounded-sm border bg-card transition-shadow hover:shadow-sm"
            key={video.id}
        >
