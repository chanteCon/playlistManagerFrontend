...
export default function VideoDetails({ video, onSubmit, isPending }: VideoDetailsProps) {
    ...
    return (
        <ValidatedForm schema={editSchema} onValidSubmit={onSubmit} requiredFields={new Set([])}>
            <FormField
                type="text"
                label="title"
                id="title"
            ...
            <FormTextArea
                ...
                className="mt-3"
                textareaClassName="rounded-sm min-h-6 h-auto resize-none overflow-hidden field-sizing-content border-0 bg-muted/90 p-4 text-sm leading-relaxed text-muted-foreground shadow-none focus-visible:border-1 focus-visible:ring-0 dark:bg-transparent"
            />
